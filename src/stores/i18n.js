...
const translations = {
  km: {
    ...
    google_no_password_hint:
      "គណនីនេះបង្កើតដោយ Google — ទុកពាក្យសម្ងាត់បច្ចុប្បន្នទទេ ដើម្បីកំណត់ពាក្យសម្ងាត់ដំបូង",
    ...
    admin_management: "គ្រប់គ្រងអ្នកគ្រប់គ្រង",
    super_admin_management: "គ្រប់គ្រង Super Admin",
    add_admin: "បន្ថែមអ្នកគ្រប់គ្រង",
    add_super_admin: "បន្ថែម Super Admin",
    no_admins: "គ្មានអ្នកគ្រប់គ្រងទេ",
    no_super_admins: "គ្មាន Super Admin ទេ",
    admin_created: "បានបង្កើតអ្នកគ្រប់គ្រងថ្មីរួចរាល់",
    super_admin_created: "បានបង្កើត Super Admin ថ្មីរួចរាល់",
    admin_deleted: "បានលុបអ្នកគ្រប់គ្រងរួចរាល់",
    super_admin_deleted: "បានលុប Super Admin រួចរាល់",
    fill_required_fields: "សូមពោហកូនចំនួនទាំងអស់",
    password_min_length: "ពាក្យសម្ងាត់ត្រូវតែយ៉ាងតិច ៨ តួអក្សរ",
    restaurant_owner: "ម្ចាស់ភោជនីយដ្ឋាន",
    ...
    report_from: "ចាប់ពី",
    report_to: "ដល់",
    report_today: "ថ្ងៃនេះ",
    orders_history: "ប្រវត្តិការបញ្ជាទិញ",
    no_orders_today: "មិនមានការបញ្ជាទិញថ្ងៃនេះ",
    ...
    report_last_month: "ខែមុន",
    report_this_year: "ឆ្នាំនេះ",
    report_group: "ដាក់ជាក្រុម",
    report_group_day: "តាមថ្ងៃ",
    report_group_week: "តាមសប្តាហ៍",
    report_group_month: "តាមខែ",
    report_chart_title: "ចំណូលតាមរយៈពេល",
    report_top_title: "មុខម្ហូបលក់ដាច់បំផុត",
    report_hours_title: "ការកម្មង់តាមម៉ោង",
    report_tables_title: "ការកម្មង់តាមតុ",
    report_status_title: "ស្ថានភាពការកម្មង់",
    report_avg_order: "កម្មង់មធ្យម",
    report_items_sold: "មុខម្ហូបលក់បាន",
    report_best_period: "រយៈពេលល្អបំផុត",
    report_qty: "ចំនួន",
    report_export: "ទាញយក CSV",
    report_exporting: "កំពុងទាញយក...",
    report_export_ok: "ទាញយករួចរាល់!",
    report_export_err: "ទាញយកមិនបានជោគជ័យ",
    report_ds_summary: "សេចក្តីសង្ខេប",
    report_ds_orders: "ការកម្មង់ទាំងអស់",
    report_ds_series: "ចំណូលតាមរយៈពេល",
    report_ds_items: "មុខម្ហូបលក់ដាច់",
    report_ds_tables: "តាមតុ",
    report_ds_hours: "តាមម៉ោង",
    report_ds_status: "តាមស្ថានភាព",
  },
  en: {
    ...
    super_admin_management: "Manage Super Admins",
    add_admin: "Add Admin",
    add_super_admin: "Add Super Admin",
    no_admins: "No admins yet",
    no_super_admins: "No super admins yet",
    ...
    orders_search_date: "Search by date",
    no_orders_date: "No orders on the selected date",
    nf_title: "Page not found",
    nf_desc: "សូមអភ័យទោស, ទំព័រដែលអ្នកកំពុងស្វែងរកមិនមានទេ ឬបានផ្លាស់ទីរួចហើយ។",
    nf_gohome: "Go home",
    nf_login: "Log in",
    ...
    report_group: "Group by",
    report_group_day: "Daily",
    report_group_week: "Weekly",
    report_group_month: "Monthly",
    report_chart_title: "Revenue over time",
    report_top_title: "Top-selling dishes",
    report_hours_title: "Orders by hour",
    report_tables_title: "Orders by table",
    report_status_title: "Order status",
    report_avg_order: "Avg order value",
    report_items_sold: "Items sold",
    report_best_period: "Best period",
    report_qty: "Qty",
    report_export: "Export CSV",
    report_exporting: "Exporting...",
    report_export_ok: "Export ready!",
    report_export_err: "Could not export the report",
    report_ds_summary: "Summary",
    report_ds_orders: "All orders",
    report_ds_series: "Revenue by period",
    report_ds_items: "Top dishes",
    report_ds_tables: "By table",
    report_ds_hours: "By hour",
    report_ds_status: "By status",
  },
};
